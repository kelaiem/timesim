...
const DE = {
  ...
  'Seven parts wear a ring — each one is a handle': 'Sieben Teile tragen einen Ring — jedes davon ist ein Griff',
  'Drag a ringed handle — either crown, the pusher, the fusee, the fourth wheel, the escape wheel or the balance': 'Einen umringten Griff ziehen — eine der beiden Kronen, den Drücker, die Schnecke, das Sekundenrad, das Ankerrad oder die Unruh',
...
const ZH = {
  ...
  // §93 — the handle rings and what each one moves.
  'Seven parts wear a ring — each one is a handle': '七个零件带圆环 — 每个都是可拖动的手柄',
  'Drag a ringed handle — either crown, the pusher, the fusee, the fourth wheel, the escape wheel or the balance': '拖动带圆环的手柄 — 两个表冠、按钮、宝塔轮、四轮、擒纵轮或摆轮',
