...
const DE = {
  ...
  'Ten rings — each one is a handle': 'Zehn Ringe — jeder davon ist ein Griff',
  'Drag a ringed handle — either crown, the pusher, the fusee, the fourth wheel, the reserve wheel, the alarm corner, the sub-dial ring, the escape wheel or the balance': 'Einen umringten Griff ziehen — eine der beiden Kronen, den Drücker, die Schnecke, das Sekundenrad, das Reserverad, die Weckerecke, den Hilfszifferblatt-Ring, das Ankerrad oder die Unruh',
...
const ZH = {
  ...
  // §93 — the handle rings and what each one moves.
  'Ten rings — each one is a handle': '十个圆环 — 每个都是可拖动的手柄',
  'Drag a ringed handle — either crown, the pusher, the fusee, the fourth wheel, the reserve wheel, the alarm corner, the sub-dial ring, the escape wheel or the balance': '拖动带圆环的手柄 — 两个表冠、按钮、宝塔轮、四轮、储能轮、闹铃转角、小表盘圆环、擒纵轮或摆轮',
...
const FR = {
  ...
  ['Ten rings — each one is a handle']: 'Dix anneaux — chacun est une poignée',
  ['Drag a ringed handle — either crown, the pusher, the fusee, the fourth wheel, the reserve wheel, the alarm corner, the sub-dial ring, the escape wheel or the balance']: 'Glissez une poignée annelée — l’une des couronnes, le poussoir, la fusée, la roue de seconde, la roue de réserve, l’angle du réveil, l’anneau de compteur, la roue d’échappement ou le balancier',
...
const JA = {
  ...
  ['Ten rings — each one is a handle']: '十のリング — どれも取っ手です',
  ['Drag a ringed handle — either crown, the pusher, the fusee, the fourth wheel, the reserve wheel, the alarm corner, the sub-dial ring, the escape wheel or the balance']: 'リング付きの取っ手をドラッグ — いずれかのりゅうず、プッシャー、フュジー、四番車、リザーブ車、アラーム隅、スモールダイヤル環、がんぎ車、テンプ',
...
const ZH_HANT = {
  ...
  ['Ten rings — each one is a handle']: '十個環 — 每一個都是把手',
  ['Drag a ringed handle — either crown, the pusher, the fusee, the fourth wheel, the reserve wheel, the alarm corner, the sub-dial ring, the escape wheel or the balance']: '拖曳一個帶環的把手 — 任一錶冠、按把、寶塔輪、秒輪、儲存輪、鬧鈴轉角、小錶盤環、擒縱輪或擺輪',
