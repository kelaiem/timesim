...
|---|---|---|
| **r 3.6** | **72 of 72 — the whole 360°** | **0.4161** |
| r 5 | 18 of 72 — 90° | 0.1509 |
| r 7 | 13 of 72 — 65° | 0.0510 |
| r 14.261 (today's whole arm) | 9 of 72 — 45°, in 5–15° fragments | 0.0510 |

So a reader confined to the track's own radius orbits freely with **0.4161**
of clearance, about 2.8× `CLEAR_MARGIN`. Today's feeler reaches r 2.91 → 14.261
and gets 45° of scattered fragments, dominated by the **alarm release sleeve
(130°)**, then the power-reserve train (50°), the alarm setting idler (40°),
the selector (35°) and the link (25°).
