...
//
//   node tools/probe-116-locale-fit.mjs [--locales en,de,fr,es,pt,it,ko,ru,ja,zh-Hant,zh,ar]
//
...
const LOCALES = argOf('--locales', 'en,de,fr,es,pt,it,ko,ru,ja,zh-Hant,zh,ar').split(',');
