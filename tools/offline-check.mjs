...
try {
  ...
  // §211 — 39: Korean's two tables. §213 — 41: Russian's. §214 — 43: Portuguese's.
  check('release: precache complete', counts === 43, `${counts}/43`);
  ...
  for (const code of ['de', 'fr', 'es', 'pt', 'ko', 'ru', 'ja', 'zh', 'zh-Hant', 'ar']) {
